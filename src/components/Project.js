              ...
              >
                <div style={{ padding: "5px" }}>
                  ...
                  <div style={{ fontSize: "14px" }}>
                    ...
                    범위에 대한 사전 협의가 부족하여 어려움이 있었습니다. 하지만
                    코드리뷰, 회의 등을 통해 전달이 안되었던 부분을 해결하면서
                    뿌듯함을 느꼈습니다.
                    <br />
                    <br />
                    그리고 프로젝트를 진행하게되면서 Spring Security와 JWT 등
                    다양한 라이브러리를 접하면서 이를 잘 활용하는 것이 개발 능력
                    향상에 필수적임을 느꼈습니다.
                  </div>
                </div>
              </p>
